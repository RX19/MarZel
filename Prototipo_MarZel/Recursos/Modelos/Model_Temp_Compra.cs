...
namespace Prototipo_MarZel
{
    public abstract class Temp_Compra_Base
    {
        ...
        public abstract void Asignar_ID_Proveedor(int Id_Compra, int Id_Proveedor);

        public abstract void Asignar_ID_Producto(int Id_Compra, int Id_Producto, string Codigo_Barra);
