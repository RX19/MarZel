...
namespace Prototipo_MarZel
{
    public abstract class Cliente_Base
    {
        ...
        public abstract void Agregar_Cliente(string RTN, string Nombre, string Direccion, string Celular, int Cant_Compras, decimal Importe);

        public abstract void Modificar_Cliente(int Id_Cliente, string RTN, string Nombre, string Direccion, string Celular);

        public abstract void Modificar_Cliente(int Id_Cliente, string RTN, string Nombre, string Direccion, string Celular, int Cant_Compras, decimal Importe);
